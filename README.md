...
| [ft_strlcpy](https://github.com/Elwoll/r0-libft/blob/main/Mandatory/ft_strlcpy.c) | ```size_t  ft_strlcpy(char  *dst, const  char  *src, size_t  n);``` | Copies the data in the ```n``` bytes  |
| [ft_strlcat](https://github.com/Elwoll/r0-libft/blob/main/Mandatory/ft_strlcat.c) | ```size_t  ft_strlcat(char  *dst, const  char  *src, size_t  n);``` | concatenate the data in the ```n``` bytes  strings |
